[![npm version](https://img.shields.io/npm/v/@kollorg/laboriosam-neque.svg)](https://www.npmjs.com/package/@kollorg/laboriosam-neque)
[![Downloads](https://img.shields.io/npm/dm/@kollorg/laboriosam-neque.svg)](https://www.npmjs.com/package/@kollorg/laboriosam-neque)
[![Build Status](https://github.com/kollorg/laboriosam-neque/workflows/CI/badge.svg)](https://github.com/kollorg/laboriosam-neque/actions)
...
```
npm i @kollorg/laboriosam-neque --save
```
...
```js
import * as eslintScope from '@kollorg/laboriosam-neque';
```

To use in a CommonJS file:

```js
const eslintScope = require('@kollorg/laboriosam-neque');
```
...
2. `options` (optional) - Options to adjust how the scope is analyzed, including:
  ...
  * `childVisitorKeys` (default: `null`) - An object with visitor key information (like [`eslint-visitor-keys`](https://github.com/eslint/eslint-visitor-keys)). Without this, `@kollorg/laboriosam-neque` finds child nodes to visit algorithmically. Providing this option is a performance enhancement.
...
Issues and pull requests will be triaged and responded to as quickly as possible. We operate under the [ESLint Contributor Guidelines](http://eslint.org/docs/developer-guide/contributing), so please be sure to read them before contributing. If you're not sure where to dig in, check out the [issues](https://github.com/kollorg/laboriosam-neque/issues).
